...
<div class="content" id="content">
        ...
        <div class="tabs-menu1 px-3">
            <ul class="nav-list">
                <li class="nav-button" data-url="transfers.php">Inventory</li>
                <li class="nav-button active" data-url="reqtransfer.php">Transfer Request</li>
<!-- 
        ...
        <section>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>TR-001</td>
                        <td>Paracetamol 500mg<br>Note: Urgent need for pharmacy</td>
                        <td>50</td>
                        <td>Emergency Department<br><span class="status high">Internal</span></td>
                        <td>N/A<br><span class="status high">External</span></td>
                        <td>Apr 7, 2025</td>
                        <td><span class="status high">Pending</span></td>
                        <td>
                            <button class="btn btn-outline-dark"><i class="bi bi-check-lg">Approve</i></button>
                    ...
                    <tr>
                        ...
                        <td>Emergency Department<br><span class="status high">Internal</span></td>
                        <td>Apr 5, 2025</td>
                        <td><span class="status high">Approved</span></td>
                        <td>
                            <button class="btn btn-outline-dark"><i class="bi bi-truck"> Mark Delivered</i></button>
                        </td>
                    </tr>
